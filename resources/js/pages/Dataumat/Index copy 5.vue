    ...
    <div class="mx-auto flex max-w-7xl flex-col rounded-xl bg-white p-4 text-sm dark:bg-gray-900 dark:text-gray-200">
        <div class="mb-3 hidden rounded-lg border p-2 dark:border-gray-700 lg:block">
            <h2 class="text-xl text-gray-500 dark:text-gray-300">
                Data Umat filter_kota: {{ filter_kota }}, filter_group: {{ filter_group }}, filter_vihara: {{ filter_vihara }}
            </h2>
        </div>
            ...
            <div class="flex w-full items-center gap-3">
                <div class="flex gap-2">
                    <input
                        ...
                        class="block rounded-md border border-gray-300 p-2 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-400 dark:focus:ring-blue-400"
                    />
                    <input
                ...
                <select
                    ...
                    @change="fetchData"
                    class="block w-1/4 rounded-md border border-gray-300 p-2 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-400 dark:focus:ring-blue-400"
                >
                    <option value="0">Vegetarian (Semua)</option>
