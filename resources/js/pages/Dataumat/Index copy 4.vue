        ...
        <div class="flex w-full flex-col gap-2 lg:flex-col lg:items-center lg:gap-5">
            ...
            <div v-if="toggle" class="flex w-full items-center justify-between gap-3">
                ...
                >
                    ...
                    <option value="" v-else>Semua Kota</option>
                ...
                >
                    ...
                    <option value="" v-else>Semua Group</option>
                ...
                >
                    ...
                    <option value="" v-else>Semua Vihara</option>
                ...
                <select
                    ...
                    class="block w-1/3 rounded-md border border-gray-300 p-2 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-400 dark:focus:ring-blue-400"
                >
                    <option value="" v-if="toggle">Tahun</option>
                    <option value="" v-else>Semua Tahun</option>
                    <option v-for="tahun in tahuns_list" :key="tahun" :value="tahun">
                        {{ tahun }}
                    </option>
                </select>
            </div>
            <div v-if="!toggle" class="hidden w-full items-center gap-3 lg:flex">
                <select
                    v-model="filter_kota"
                    @change="fetchData"
                    class="block w-1/3 rounded-md border border-gray-300 p-2 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-400 dark:focus:ring-blue-400"
                ...
                <!-- <select
                        v-model="filter_pandita"
                        @change="fetchData"
                        class="block w-1/3 rounded-md border border-gray-300 p-2 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-400 dark:focus:ring-blue-400"
                    >
                        <option value="" v-if="toggle">Pandita</option>
                        <option value="" v-else>Semua Pandita</option>
                        <option v-for="pandita in panditas_list" :key="pandita.id" :value="pandita.id">
                ...
                <select
                    ...
                    class="block w-1/3 rounded-md border border-gray-300 p-2 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-blue-400 dark:focus:ring-blue-400"
                >
                    <option value="" v-if="toggle">Tahun Mohon Tao</option>
                    <option value="" v-else>Semua Tahun</option>
                    <option v-for="tahun in tahuns_list" :key="tahun" :value="tahun">
                        {{ tahun }}
                    </option>
