<table>
    ...
    <tr>
        <td colspan="21"
            style=" text-align: center; font-size: 16px; font-weight: bold; background-color: #2C5FAA; color: white; padding: 10px;">
            DATA UMAT - EXPORT
        </td>
    </tr>
    ...
    @if (count(array_filter($filters)) > 0)
        <tr>
            <td colspan="21" style=" background-color: #F0F0F0; padding: 8px; font-style: italic;">
    ...
    <tr>
        <td colspan="21" style=" background-color: #E8E8E8; padding: 8px; font-weight: bold;">
    ...
    <!-- Header Table -->
    <tr>
        <th style=" background-color: #4CAF50; color: white; padding: 8px; border: 1px solid #ddd;">
            No</th>
        <th style=" background-color: #4CAF50; color: white; padding: 8px; border: 1px solid #ddd;">
            Nama Umat</th>
        <th style=" background-color: #4CAF50; color: white; padding: 8px; border: 1px solid #ddd;">
    ...
    @foreach ($data as $index => $umat)
        <tr>
            <td style=" padding: 8px; border: 1px solid #ddd;">{{ $index + 1 }}
            </td>
            <td
                style="{{ $umat['status'] === 'Inactive' ? 'background-color:#e2e8f0;' : '' }}  padding: 8px; border: 1px solid #ddd;">
                {{ $umat['nama_umat'] }}
            </td>
    ...
    <tr>
        <td colspan="21"
            style=" background-color: #f8f9fa; padding: 8px; font-weight: bold; text-align: center; border: 1px solid #ddd;">
